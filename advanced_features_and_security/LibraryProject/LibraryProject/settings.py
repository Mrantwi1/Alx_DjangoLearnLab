...
SECRET_KEY = 'django-insecure-+27m6f^&ke9+e+^#kb+j!!0rmcu+aukmr%0-gryh_%u)(@7njt'
...
# Required: Django redirects users here after a successful login (use the name you set in urls.py)
LOGIN_REDIRECT_URL = 'book_list'

# Optional: Redirect users here after they log out
...
# --- Step 1: Secure Proxy Header (Required by Checker) ---

# Tells Django to trust the X-Forwarded-Proto header from the proxy (Nginx/Apache)
# when checking if a request is secure (HTTPS).
